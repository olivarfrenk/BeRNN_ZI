    ...
    for i in range(rangeList[0], rangeList[1]):
        ...
        while noChange == False:
            ...
            for l in range(len(fieldNumberList)):
                if abs(fieldNumberList[0] - fieldNumberList[l]) <= 2 and l != 0 or abs(
                        fieldNumberList[0] - fieldNumberList[l]) >= 30:
                    fieldNumberList[l] = random.sample(fieldList, 1)[0]
                else:
                    countNoChange += 1

                if abs(fieldNumberList[1] - fieldNumberList[l]) <= 2 and l != 1 or abs(
                        fieldNumberList[0] - fieldNumberList[l]) >= 30:
                    fieldNumberList[l] = random.sample(fieldList, 1)[0]
                else:
                    countNoChange += 1
        ...
        if ratioMatches[0] == 0:
            ...
            while diffFound == False:
                ...
                if firstStim_currentTrial_form == firstStim_memory2_form and secondStim_currentTrial_form == secondStim_memory2_form or \
                            firstStim_currentTrial_form == secondStim_memory2_form and secondStim_currentTrial_form == firstStim_memory2_form:
                    diffFound = True
                else:
                    diffFound = False
...
trials_easy.to_excel('spreadsheetEasy_WorkingMemory_Ctx2.xlsx')
...
def assignFunc_form(form1, form2, form3, form4, form5, form6):
...
for displays in range(2):
    ...
    for i in range(rangeList[0], rangeList[1]):
        ...
        while stimFound == False:
            ...
            stimFound = assignFunc_form(f1, f2, f3, f4, f5, f6)
...
# Save df as spreadsheet
trials_normal.to_excel('spreadsheetNormal_WorkingMemory_Ctx2.xlsx')
