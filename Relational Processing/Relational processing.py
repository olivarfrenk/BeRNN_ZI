...
for displays in range(2):
    ...
    for iter in range(rangeList[0],rangeList[1]):
        ...
        trials_easy.loc[i, 36] = stimList[0].iloc[0,0]
...
def assignFunc_color(color1, color2, color3):
    if splitted_otherStim_Color == color1 or splitted_otherStim_Color == color2 or splitted_otherStim_Color == color3:
        # append
        stimList.append(otherStim)
        stimFound = True
        return stimFound
...
for displays in range(2):
    ...
    for iter in range(rangeList[0],rangeList[1]):
        ...
        # Save correct answer to real df
        trials_normal.loc[i, 36] = stimList[0].iloc[0, 0]
...
for displays in range(2):
    ...
    for iter in range(rangeList[0],rangeList[1]):
        ...
        # Save correct answer to real df
        trials_hard.loc[i, 36] = stimList[0].iloc[0, 0]
