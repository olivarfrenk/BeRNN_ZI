...
# Save df as spreadsheet
trials_normal.to_excel('spreadsheetNormal_WorkingMemory.xlsx')
...
# Look for TwinMemoryTask_functionTrialsHard.py > decreased amount of lines from ~700 to ~100
