...
trials_easy.to_excel('spreadsheetEasy_DecisionMaking_Anti.xlsx')
...
# Save df as spreadsheet
trials_normal.to_excel('spreadsheetNormal_DecisionMaking_Anti.xlsx')
...
# Save df as spreadsheet
trials_hard.to_excel('spreadsheetHard_DecisionMaking_Anti.xlsx')